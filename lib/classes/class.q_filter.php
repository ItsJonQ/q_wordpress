...
/**
 * q_filter
 * This is the filter class for the q_ wordpress theme
 *
 * @class
 *
 * @package q_
...
// Defining the q_filter class
if(!class_exists('q_filter')) {
    ...
    class q_filter {
        ...
        public static function init() {
            ...
            // Content Filters
            add_filter( 'the_content', array( 'q_filter', 'content_iframes_replace_tag' ));
            add_filter( 'the_content', array( 'q_filter', 'content_images_replace_tag' ));

            // Excerpt filers
            add_filter('excerpt_more', array( 'q_filter', 'excerpt_read_more' ) );
        }
    ...
    // Initialize
    add_action( 'init' , array( 'q_filter' , 'init' ) );
